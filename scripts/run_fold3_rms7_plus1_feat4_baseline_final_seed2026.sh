...
# Official confirmation: Baseline-final (RMS7 + Feat_4), fold3 c1,c6 -> c4
...
RUNTIME_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/runtime_rms7_plus_feat4_baseline_final_fold3_gpu${GPU_ID}"
...
model_id="PHM_c1c6_to_c4_rms7_plus_feat4_BaselineFinal_dual_seed${seed}_e${train_epochs}_bt${batch_size}_gpu${GPU_ID}"
