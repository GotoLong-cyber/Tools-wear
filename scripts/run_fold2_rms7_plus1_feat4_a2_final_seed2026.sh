...
# Official confirmation: A2-final = Random-S2, fold2 c4,c6 -> c1
...
RUNTIME_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/runtime_rms7_plus_feat4_a2_final_fold2_gpu${GPU_ID}"
...
model_id="PHM_c4c6_to_c1_rms7_plus_feat4_A2Final_dual_seed${seed}_e${train_epochs}_bt${batch_size}_gpu${GPU_ID}"
