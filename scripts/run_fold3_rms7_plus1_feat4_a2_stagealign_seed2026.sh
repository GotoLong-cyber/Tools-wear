...
# A2 Fold-3 对照实验（磨损阶段对齐切片）
# train/val: c1,c6 ; test: c4
...
SELECTED_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/selected_rms7_plus_feat4_a2_stagealign_fold3"
RUNTIME_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/runtime_rms7_plus_feat4_a2_stagealign_fold3_gpu${GPU_ID}"
...
"${PYTHON_BIN}" "${PROJECT_ROOT}/feature_alignment_diagnosis/scripts/build_a2_stage_aligned_fold1_data.py" \
  ...
  --output_dir "dataset/passlevel_tree_select/selected_rms7_plus_feat4_a2_stagealign_fold3" \
  --runs c1 c4 c6 \
  --train_runs c1 c6 \
...
model_id="PHM_c1c6_to_c4_rms7_plus_feat4_A2stagealign_dual_seed${seed}_e${train_epochs}_bt${batch_size}_gpu${GPU_ID}"
