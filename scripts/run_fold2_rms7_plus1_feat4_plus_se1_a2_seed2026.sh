...
RUNTIME_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/runtime_rms7_plus_feat4_plus_se1_a2_fold2_gpu${GPU_ID}"
...
model_id="PHM_c4c6_to_c1_rms7_plus_feat4_plus_se1_A2_dual_seed2026_e${TRAIN_EPOCHS:-1000}_bt96_gpu${GPU_ID}"
