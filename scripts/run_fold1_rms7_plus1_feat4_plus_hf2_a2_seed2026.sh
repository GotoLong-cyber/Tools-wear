...
RUNTIME_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/runtime_rms7_plus_feat4_plus_hf2_a2_fold1_gpu${GPU_ID}"
...
model_id="PHM_c1c4_to_c6_rms7_plus_feat4_plus_hf2_A2_dual_seed2026_e${TRAIN_EPOCHS:-1000}_bt96_gpu${GPU_ID}"
