...
RUNTIME_DIR="${PROJECT_ROOT}/dataset/passlevel_tree_select/runtime_rms7_plus_feat4_a2_dynstride_fold1_gpu${GPU_ID}"
...
model_id="PHM_c1c4_to_c6_rms7_plus_feat4_A2dynstride_dual_seed${seed}_e${train_epochs}_bt${batch_size}_gpu${GPU_ID}"
